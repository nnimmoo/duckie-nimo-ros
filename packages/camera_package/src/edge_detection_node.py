...
class EdgeDetectionNode(DTROS):
    ...
    def callback(self, msg):
        ...
        img_cv2 = img_cv2[round(dimension[0]/1.5):dimension[0], round(dimension[1]/3):round(dimension[1]-dimension[1]/3), :]
 
        yellow_lower = np.array([16, 50, 50], dtype="uint8")
        yellow_upper = np.array([21, 255, 255], dtype="uint8")
